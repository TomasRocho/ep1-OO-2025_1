...
public class TurmaListaController {
    ...
    public void initialize(){
        ...
        disciplinaColumn.setPrefWidth(100);
        ...
        tipoAvaliacaoColumn.setPrefWidth(140);
        ...
        TableColumn<Turma, Integer> qtdAlunoColumn = new TableColumn<>("Capacidade máxima de alunos");
        qtdAlunoColumn.setPrefWidth(200);
